...
from aclnet import __version__
from aclnet.apis import init_random_seed, train_model
from aclnet.datasets import build_dataset
from aclnet.models import build_model
from aclnet.utils import collect_env, get_root_logger, mc_off, mc_on, test_port
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save aclnet version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(
            aclnet_version=__version__ + get_git_hash(digits=7),
